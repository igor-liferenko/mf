...
bool init_screen(void)
{
  ...
  system("pgrep hello-wayland|sed -n \"$(pgrep --parent `pgrep -x virmf|paste -sd,|sed 's/^$/0/'` hello-wayland|sed '$!N;$!b;s#\\n#/b;/#g;s#^#/#;s#$#/b;s/^/kill /e#')\""); /* destroy orphaned online display(s) - see README */
