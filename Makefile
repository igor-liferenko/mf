all:
	...
	@sed -i "\|%.*lgrusu|e sed '/endinput/d;/CYR_.YO\\\\|CYR_.I_shrt/a charht:=cap_height#;' MFinputs/lh/lgrusu.mf" MFinputs/om/OM* # make height of uppercase accented characters the same as non-accented ones
