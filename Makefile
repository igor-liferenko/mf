all:
	...
	@rm -f ~/.PKfonts/*/* # mode parameters could change (if you change here, change also in mytex/dvips)
...
CHF=charset.ch path.ch interrupt.ch arg.ch print.ch preload.ch time.ch log.ch edit.ch name.ch exit.ch search.ch
