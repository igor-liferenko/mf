all:
	...
	tie -c mf.ch mf.w $(CHF) path.ch constants.ch edit.ch time.ch screen.ch comment.ch >/dev/null
	ctangle mf mf
...
CHF=charset.ch interrupt.ch arg.ch print.ch preload.ch log.ch exit.ch close.ch 64bit.ch
